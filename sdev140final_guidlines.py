...
from tkinter import*
#from PIL import Image, ImageTk - ommitted because images were causing errors and would stop program from running
import calendar
...
#image = Image.open("mice_image.jpg")
#image = ImageTk.PhotoImage(image)

#image_label = Label(root, image=image)
#image_label.pack()

#image = Image.open("mouse_image.webp")
#image = ImageTk.PhotoImage(image)
